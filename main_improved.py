...
def main():
    ...
    # If True, we will skip subtitle processing/burning but still run face crop/edit steps.
    ...
    try:
        ...
        # 5. Workflow Check
        # Workflow 2 now means: Cut + Face Crop (9:16) but NO subtitles burned.
        if workflow_choice == "2":
            skip_subtitles = True
            print(i18n("Cut Only selected. Keeping Face Crop (9:16), skipping Subtitles."))
        ...
        # 6. Subtitles
        burn_subtitles_option = (not skip_subtitles) 
